function tri_contour(elm_som,som_x,som_y,som_u,hautr)
...
%
% Copyright (c) 2010 by Frederic Pascal, ENS de CACHAN
...
% Verification nb de sommets
if size(elm_som,2)~= 3
   error('Nombre de sommets par volume/element different de 3')
end
...
for h=hautr
    ...
    a=plot(plt_x,plt_y);
    set(a,'Color',map(max(1,round(i*128/nb)),:))
    hold on
